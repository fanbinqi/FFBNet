...
parser.add_argument('--lr', '--learning-rate',
                    default=0.003, type=float, help='initial learning rate')
parser.add_argument('--momentum', default=0.9, type=float, help='momentum')	

#parser.add_argument('--resume_net', default='weights/FSSD_vgg2302/FSSD_vgg_VOC_epoches_140.pth', help='resume net for retraining')
...
def train():
    ...
    for iteration in range(start_iter, max_iter + 10):
        ...
        images = Variable(images.cuda())
        targets_a, targets_b = [Variable(anno_a) for anno_a in targets_a], [Variable(anno_b) for anno_b in targets_b]
