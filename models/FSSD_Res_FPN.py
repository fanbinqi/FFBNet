...
def feature_transform_module(scale_factor):
    layers = []
    # laer2
    layers += [BasicConv(int(128 * scale_factor), 256, kernel_size=1, padding=0)]
    #layers += [down_sample(int(256 * scale_factor), 256)]
    # laer3
    layers += [BasicConv(int(256 * scale_factor), 256, kernel_size=1, padding=0, up_size=38)]
...
#flops, params = profile(net, input_size=(32, 3, 300, 300))
#net = net.forward(input1)
#detect_time = t['im_detect'].toc()
# net2 = resnet18()
# flops, params = profile(net2, input_size=(32, 3, 300, 300))
# print(flops)
#output = net(input1)
